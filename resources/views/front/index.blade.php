...
<div id="Products" class="container max-w-[1130px] mx-auto flex flex-col gap-10 lg:gap-20 mt-20 px-4 lg:px-0">
    ...
    <div class="product flex flex-col lg:flex-row lg:flex-wrap justify-center items-center gap-6 lg:gap-[60px] lg:even:flex-row-reverse">
        <!-- Product Image -->
        <div class="w-full max-w-[320px] h-[240px] lg:w-[400px] lg:h-[550px] flex shrink-0 overflow-hidden rounded-[12px] lg:rounded-[20px]">
            <img src="{{ Storage::url($product->thumbnail) }}"
                 class="w-full h-full object-cover rounded-[12px] lg:rounded-[20px]"
                 alt="thumbnail">
        </div>
        ...
        <div class="flex flex-col gap-4 lg:gap-[30px] py-0 lg:py-[50px] h-fit max-w-full lg:max-w-[500px] text-center lg:text-left">
            ...
            <div class="flex flex-col gap-2 lg:gap-[10px]">
                ...
                <p class="leading-[24px] lg:leading-[30px] text-cp-light-grey text-sm lg:text-base">
                    {{ $product->about }}
                </p>
            </div>
            ...
            <a href="{{ route('front.appointment') }}"
                class="bg-cp-dark-red p-[12px_18px] lg:p-[14px_20px] w-full sm:w-fit rounded-xl hover:shadow-[0_12px_30px_0_#FF0000] transition-all duration-300 font-bold text-white text-center mx-auto lg:mx-0">
                Pesan Sekarang
            </a>
        </div>
    </div>
