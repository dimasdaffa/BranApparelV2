    ...
    <div class="logo-container flex flex-wrap gap-5 justify-center">
        ...
        <div
            ...
            <div class="overflow-hidden h-9 w-9">
                <img src="{{ Storage::url($team->avatar) }}" class="object-cover w-full h-full" alt="{{ $team->name }}">
            </div>
    ...
    <div class="flex flex-wrap items-center gap-[30px] justify-center">
        ...
        <div
            ...
            <div class="thumbnail h-[200px] flex shrink-0 overflow-hidden">
                <img src="{{ Storage::url($principle->thumbnail) }}" class="object-cover object-center w-full h-full"
                    alt="thumbnails">
            </div>
...
<div id="Teams" class="bg-[#F6F7FA] w-full py-20 px-[10px] mt-20">
    <div class="container max-w-[1130px] mx-auto flex flex-col gap-[30px] items-center">
        ...
        <div
            ...
            <div
                class="card bg-white flex flex-col h-full justify-center items-center p-[30px] px-[29px] gap-[30px] border border-white hover:shadow-[0_10px_30px_0_#D1D4DF80] hover:border-cp-dark-blue transition-all duration-300">
                <div
                    class="w-[100px] h-[100px] flex shrink-0 items-center justify-center ">
                    <div class="w-[90px] h-[90px]  overflow-hidden">
